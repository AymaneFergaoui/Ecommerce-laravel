        ...
        <div class="container">
            <div class="row">
                <div class="nov-row  col-lg-12 col-xs-12" ><div class="nov-row-wrap row">
                        <!-- begin novpagemanage/views/source/html -->
                        ...
                        <!-- end novpagemanage/views/source/html -->

                        <!-- begin novpagemanage/views/source/slider -->
                        <div id="nov-slider" class="slider-wrapper theme-default col-xl-9 col-lg-9 col-md-9 col-md-12" style="margin-top: 35px;"
                             data-effect="random"
                             data-slices="15"
                             data-animSpeed="500"
                            ...
                            <div class="nivoSlider">
                                <a href="#">
                                    <img src="{{asset('assets/front/images/home/slide1.webp')}}" alt="" title="#htmlcaption_42" />
                                </a>
                                <a href="#">
                                    <img src="{{asset('assets/front/images/home/slide1.webp')}}" alt="" title="#htmlcaption_43" />
                                </a>
                                <a href="#">
                                    <img src="{{asset('assets/front/images/home/slide1.webp')}}" alt="" title="#htmlcaption_57" />
                                </a>
                            </div>
                        ...
                        <!-- end novpagemanage/views/source/slider -->
                    </div></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="nov-row spacing-30 mt-15 col-lg-12 col-xs-12" ><div class="nov-row-wrap row">
                        <!-- begin novpagemanage/views/source/image -->
                        <div class="nov-image col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <div class="effect">
                                        <a href="#"> <img class="img-fluid" src="{{asset('assets/front/images/home/bn_13.webp')}}" alt="banner3-1" title="banner3-1"></a>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <!-- end novpagemanage/views/source/image -->
                        ...
                        <div class="nov-image col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <div class="effect">
                                        <a href="#"> <img class="img-fluid" src="{{asset('assets/front/images/home/bn_14.webp')}}" alt="banner3-2" title="banner3-2"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="nov-image col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <div class="effect">
                                        <a href="#"> <img class="img-fluid" src="{{asset('assets/front/images/home/bn_15.webp')}}" alt="banner3-3" title="banner3-3"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- begin novpagemanage/views/source/countdown_product -->
                                            ...
                                            <div class="product-miniature js-product-miniature first_item" data-id-product="12" data-id-product-attribute="232" itemscope itemtype="http://schema.org/Product">
                                                <div class="thumbnail-container">
                                                    ...
                                                    <a href="http://demo.bestprestashoptheme.com/savemart/ar/home-appliance/12-232-nam-volutpat-justo-a-vehicula.html#/1-الحجم-ص/11-اللون_-اسود" class="thumbnail product-thumbnail two-image">
                                                        <img class="img-fluid image-cover" src = "{{asset('assets/front/images/home/bn_12.webp')}}"
                                                             alt = ""
                                                             data-full-size-image-url = "{{asset('assets/front/images/home/bn_12.webp')}}"
                                                             width="600"
                                                             height="600"
                                                        >
                                                        <img
                                                            class="img-fluid image-secondary"
                                                            src = "{{asset('assets/front/images/home/bn_12.webp')}}"
                                                            alt = ""
                                                            data-full-size-image-url = "{{asset('assets/front/images/home/bn_11.webp')}}"
                                                            width="600"
                                                            height="600"
                                                        >
                                                    </a>
                                                ...
                                                <div class="product-description">
                                                    <div class="product-groups">
                                                        ...
                                                        <!-- begin novproductcomments/novproductcomments_reviews -->
                                                        ...
                                                        <!-- end novproductcomments/novproductcomments_reviews -->

                                                        <!-- begin jmarketplace/views/templates/hook/product-list -->
                                                        <p class="seller_name">
                                                        ...
                                                        <!-- end jmarketplace/views/templates/hook/product-list -->
                                                        ...
                                                        <div class="product-group-price">
                                                            ...
                                                            <div class="product-price-and-shipping">
                                                                ...
                                                                <span itemprop="price" class="price">7.56 DH</span>



                                                                <span class="regular-price">10.80 DH</span>
                                                    ...
                                                    <div class="product-buttons d-flex justify-content-center" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                                        <form action="http://demo.bestprestashoptheme.com/savemart/ar/عربة التسوق" method="post" class="formAddToCart">
                                                            ...
                                                            <a class="add-to-cart" href="#" data-button-action="add-to-cart"><i class="fa-solid fa-cart-shopping"></i><span>أضف للسلة</span></a>
                                                        </form>

                                                        <!-- begin novblockwishlist/novblockwishlist_button -->
                                                        ...
                                                        <!-- end novblockwishlist/novblockwishlist_button -->
                                                ...
                                                <!-- begin novthemeconfig/views/templates/hook/countdown -->
                                                <div class="countdownfree d-flex" data-date="2021/12/30"></div>

                                                <!-- end novthemeconfig/views/templates/hook/countdown -->
                                                    ...
                                                    <div class="product-groups">
                                                        ...
                                                        <div class="product-group-price">
                                                            ...
                                                            <div class="product-price-and-shipping">
                                                                ...
                                                                <span itemprop="price" class="price">37.80 DH</span>



                                                                <span class="regular-price">42.00 DH</span>
                                                    ...
                                                    <div class="product-groups">
                                                        ...
                                                        <div class="product-group-price">
                                                            ...
                                                            <div class="product-price-and-shipping">
                                                                ...
                                                                <span itemprop="price" class="price">21.60 DH</span>



                                                                <span class="regular-price">24.00 DH</span>
                                                    ...
                                                    <div class="product-groups">
                                                        ...
                                                        <div class="product-group-price">
                                                            ...
                                                            <div class="product-price-and-shipping">
                                                                ...
                                                                <span itemprop="price" class="price">16.20 DH</span>



                                                                <span class="regular-price">18.00 DH</span>
                        ...
                        <!-- end novpagemanage/views/source/countdown_product -->

                        <!-- begin novpagemanage/views/source/productlist -->
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">24.00 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">36.00 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">30.00 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">18.00 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">34.80 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">14.28 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">12.00 DH</span>
                        ...
                        <!-- end novpagemanage/views/source/productlist -->
                        ...
                        <div class="nov-image col-lg-6 col-md-6">
                            <div class="block">
                                <div class="block_content">
                                    <div class="effect">
                                        <a href="#"> <img class="img-fluid" src="{{asset('assets/front/images/home/bn_11.webp')}}" alt="banner-4" title="banner-4"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="nov-image col-lg-6 col-md-6">
                            <div class="block">
                                <div class="block_content">
                                    <div class="effect">
                                        <a href="#"> <img class="img-fluid" src="{{asset('assets/front/images/home/bn_12.webp')}}" alt="banner-5" title="banner-5"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">14.40 DH</span>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">9.60 DH</span>



                                                                    <span class="regular-price">12.00 DH</span>
