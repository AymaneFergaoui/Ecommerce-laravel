        ...
        <div class="container">
            <div class="row">
                <div class="nov-row footer-top "  data-nov-full-width="true"><div class="nov-row-wrap row"><div class="nov-modules col-lg-12 col-md-12 "><div class="block nov-wrap"><div class="title_block">SIGN UP TO NEWSLETTER</div>
                                <!-- begin module:ps_emailsubscription/views/templates/hook/ps_emailsubscription -->
                                <!-- begin ps_emailsubscription/views/templates/hook/ps_emailsubscription --><div class="block_newsletter">
            ...
            <button class="btn btn-secondary effect-btn" name="submitNewsletter" type="submit">
                <span>subscribe</span>
                                    ...
                                    <div id="social_block">
                                        <div class="social">
                                            <ul class="list-inline mb-0 justify-content-end">
                                                <li class="list-inline-item mb-0"><a href="#" target="_blank"><i data-feather="facebook" ></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="#" target="_blank"><i data-feather="twitter" ></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="#" target="_blank"><i data-feather="youtube" ></i></a></li>
                                                <li class="list-inline-item mb-0"><a href="#" target="_blank"><i data-feather="instagram" ></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- end ps_emailsubscription/views/templates/hook/ps_emailsubscription -->
                                <!-- end module:ps_emailsubscription/views/templates/hook/ps_emailsubscription -->
                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img src="{{asset('assets/front/images/AF_logo.png')}}" alt="logo" width="167" /></p>
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="phone-support">+212-645-742-931</div>
                                        </div>
                                    </div>
                                    <div class="data-contact d-flex align-self-stretch">
