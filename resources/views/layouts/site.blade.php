...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="{{asset('assets/front/images/favicon.ico')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets/front/css/home.css')}}" type="text/css" media="all">
...
<body id="index" class="country-gb currency-gbp layout-full-width page-index tax-display-enabled">
